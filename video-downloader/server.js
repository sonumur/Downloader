...
app.use((req, res, next) => {
  ...
  const csp = [
    ...
    `frame-src https://*.n6wxm.com https://n6wxm.com https://*.rtmk.net https://my.rtmk.net https://*.ldrus.com https://*.vauvany.com https://*.propush.me https://www.google.com https://www.googletagmanager.com ${extraCspSources}`,
    `connect-src 'self' https://*.n6wxm.com https://n6wxm.com https://*.rtmk.net https://my.rtmk.net https://*.ldrus.com https://*.vauvany.com https://*.propush.me https://firestore.googleapis.com https://www.googleapis.com https://securetoken.googleapis.com https://www.googletagmanager.com https://www.gstatic.com https://*.firebasejs.map ${extraCspSources}`,
    "media-src 'self' blob:",
